...
## Version 0.3.6 - 2025-12-03

- Fixed a bug in Wi-Fi heat map colors.
  They are now based on 0-100% means -100dBm to -40dBm.
  TCP and UDP charts continue to use the
  highest value in the data set as 100%.
  This means that weak wifi signals will be
  emphasized by blue/yellow/orange/red colors.
